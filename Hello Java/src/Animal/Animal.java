 ...
 abstract class Mammal extends Animal
{
 ...
 abstract class Reptile extends Animal{
  ...
  final class Cat extends Mammal {
	    ...
	    public String bark() { System.out.println("Meow"); return "Meow"; }
	
	    public String getFood() { System.out.println("Fish"); return "Fish"; }
   ...
   final class Dog extends Mammal {
	    ...
	    @Override
	    public String bark() { System.out.println("Bowbow"); return "Bowbow"; }
	    @Override
	    public String getFood() { System.out.println("Apple"); return "Apple"; }
